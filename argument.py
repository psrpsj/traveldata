...
@dataclass
class TrainingNLPArguments(TrainingArguments):
...
@dataclass
class TrainingCat3NLPArguments(TrainingArguments):
    output_dir: str = field(default="./output/")
    num_train_epochs: int = field(default=10)
    per_device_train_batch_size: int = field(default=16)
    per_device_eval_batch_size: int = field(default=16)
...
@dataclass
class TrainCat3NLPModelArguments:
    model_name: str = field(default="klue/bert-base")
    loss_name: str = field(default="focal")
    project_cat3_name: str = field(default="cat3_nlp")
    data_path: str = field(default="./data/")
